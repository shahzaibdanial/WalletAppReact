...
class UpdateWallet extends Component {
    ...
    submitHandler =(event)=>{
       ...
       this.props.updateWallet(this.state.id,updateWallet,this.props.histroy)
                    ...
                    <div className="row">
                        <div className="col-md-8 m-auto">
                            ...
                            <form onSubmit={(event)=>this.submitHandler(event)}>
                                ...
                                <div className="form-group">
                                    <select className="form-control form-control-lg" value={this.state.priority} onChange={(event)=>this.changeHandler(event,"prirotity")}>
